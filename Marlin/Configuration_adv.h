...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 300 //tt estaba desactivado tenia 500
...
#define INPUT_SHAPING_Y //tt
    ...
    #define SHAPING_FREQ_Y  35          // (Hz) The default dominant resonant frequency on the Y axis.
 ...
 */
  ...
  #define MESH_MIN_X MESH_INSET  //tt
  #define MESH_MIN_Y MESH_INSET  //tt
  #define MESH_MAX_X X_BED_SIZE - (MESH_INSET) //tt
  #define MESH_MAX_Y Y_BED_SIZE - (MESH_INSET) //tt 
#endif
